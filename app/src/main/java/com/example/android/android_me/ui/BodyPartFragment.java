...
public class BodyPartFragment extends Fragment {
    ...
    public void onSaveInstanceState(Bundle currentInstanceState) {
        currentInstanceState.putIntegerArrayList(IMAGE_ID_LIST, (ArrayList<Integer>) mImageIds);
        currentInstanceState.putInt(LIST_INDEX, mListIndex);
    }
}
